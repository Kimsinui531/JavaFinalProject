...
// cominformation 패키지 안에 있는 Information310 클래스에서 만든 LinkedHashMap에 있는 데이터들을 이용해서 자리 버튼을 만드는 클래스
...
/**
 * SeatButtonPanel310 클래스는 자리 버튼 패널을 생성하고 관리하는 역할을 합니다.
 * <p>
 * 이 클래스는 cominformation.Information310에서 가져온 LinkedHashMap 데이터를 사용하여 자리 버튼을 동적으로 생성하며,
 ...
 *   <li>2024-12-06: SeatButtonPanel310 클래스의 GUI 색상 변경 (KIM SIN UI)</li>
...
public class SeatButtonPanel310 extends JPanel {
    ...
    private ArrayList<JButton> seatButtons; // 자리 버튼들을 저장하는 리스트
    private ArrayList<String> computerList; // 컴퓨터 정보 리스트

    /**
     * SeatButtonPanel310 클래스의 생성자입니다.
     *
     * @param information 강의실 06-310의 컴퓨터 정보를 포함하는 Information310 객체입니다.
     */
